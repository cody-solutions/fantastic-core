...
namespace Cysharp.Threading.Tasks
{
    ...
    public struct UniTaskCompletionSourceCore<TResult>
    {
        ...
        public bool TrySetResult(TResult result)
        {
            if (Interlocked.Increment(ref completedCount) == 1)
            {
                ...
                if (continuation != null || Interlocked.CompareExchange(ref this.continuation, UniTaskCompletionSourceFantasticNetShared.s_sentinel, null) != null)
                {
        ...
        public void OnCompleted(Action<object> continuation, object state, short token /*, ValueTaskSourceOnCompletedFlags flags */)
        {
            ...
            */
            ...
            if (oldContinuation != null)
            {
                ...
                if (!ReferenceEquals(oldContinuation, UniTaskCompletionSourceFantasticNetShared.s_sentinel))
                {
    ...
    internal static class UniTaskCompletionSourceFantasticNetShared // separated out of generic to avoid unnecessary duplication
    {
